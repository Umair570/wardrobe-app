...
import { Layers, RefreshCw, Sparkles, Move, Palette } from 'lucide-react'
...
export default function OutfitVisualizationPage({ outfit, onBack, onChangeClothing, onGenerateAnother }) {
  ...
  // Abdulrehman's Backend Overlay state detection
  ...
  // Your Interactive Canvas Reset Key
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 space-y-8">
      ...
      <div className="grid lg:grid-cols-5 gap-8 items-start">
        {/* ======================================================== */}
        {/* LEFT/CENTER: YOUR INTERACTIVE DRAGGABLE STAGE (3 Cols)   */}
        {/* ======================================================== */}
